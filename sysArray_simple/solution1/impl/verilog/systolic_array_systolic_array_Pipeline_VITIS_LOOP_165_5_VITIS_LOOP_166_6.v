...
module systolic_array_systolic_array_Pipeline_VITIS_LOOP_165_5_VITIS_LOOP_166_6 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [31:0] tmp_3_fu_310_p18;
reg   [31:0] tmp_3_reg_398;
wire    ap_block_pp0_stage0_01001;
reg   [2:0] j_fu_94;
wire    ap_loop_init;
reg   [2:0] ap_sig_allocacmp_j_load;
wire   [2:0] add_ln166_fu_348_p2;
reg   [2:0] i_fu_98;
reg   [2:0] ap_sig_allocacmp_i_load;
wire   [2:0] select_ln165_1_fu_282_p3;
reg   [4:0] indvar_flatten15_fu_102;
reg   [4:0] ap_sig_allocacmp_indvar_flatten15_load;
wire   [4:0] add_ln165_fu_250_p2;
wire   [0:0] icmp_ln166_fu_262_p2;
wire   [2:0] add_ln165_1_fu_276_p2;
wire   [2:0] select_ln165_fu_268_p3;
wire   [1:0] trunc_ln165_fu_290_p1;
wire   [1:0] trunc_ln167_fu_294_p1;
wire   [3:0] tmp_1_fu_298_p3;
wire   [4:0] tmp_3_fu_310_p17;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln165_fu_244_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln165_fu_244_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_3_reg_398 <= tmp_3_fu_310_p18;
    end
end

always @ (*) begin
    if (((icmp_ln165_fu_244_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln165_1_fu_276_p2 = (ap_sig_allocacmp_i_load + 3'd1);

assign add_ln165_fu_250_p2 = (ap_sig_allocacmp_indvar_flatten15_load + 5'd1);

assign add_ln166_fu_348_p2 = (select_ln165_fu_268_p3 + 3'd1);
...
assign icmp_ln165_fu_244_p2 = ((ap_sig_allocacmp_indvar_flatten15_load == 5'd16) ? 1'b1 : 1'b0);

assign icmp_ln166_fu_262_p2 = ((ap_sig_allocacmp_j_load == 3'd4) ? 1'b1 : 1'b0);
...
assign m_axi_gmem_WDATA = tmp_3_reg_398;
...
assign select_ln165_1_fu_282_p3 = ((icmp_ln166_fu_262_p2[0:0] == 1'b1) ? add_ln165_1_fu_276_p2 : ap_sig_allocacmp_i_load);

assign select_ln165_fu_268_p3 = ((icmp_ln166_fu_262_p2[0:0] == 1'b1) ? 3'd0 : ap_sig_allocacmp_j_load);

assign tmp_1_fu_298_p3 = {{trunc_ln165_fu_290_p1}, {trunc_ln167_fu_294_p1}};

assign tmp_3_fu_310_p17 = tmp_1_fu_298_p3;

assign trunc_ln165_fu_290_p1 = select_ln165_1_fu_282_p3[1:0];

assign trunc_ln167_fu_294_p1 = select_ln165_fu_268_p3[1:0];

endmodule //systolic_array_systolic_array_Pipeline_VITIS_LOOP_165_5_VITIS_LOOP_166_6
