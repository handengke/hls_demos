...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln34_fu_1366_p2 == 1'd0)) begin
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (icmp_ln34_fu_1366_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln34_fu_1366_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln34_fu_1360_p2 = (ap_sig_allocacmp_phi_ln34_load + 2'd1);
...
assign icmp_ln14_1_fu_1052_p2 = ((ap_sig_allocacmp_phi_ln34_load == 2'd1) ? 1'b1 : 1'b0);

assign icmp_ln14_2_fu_1066_p2 = ((ap_sig_allocacmp_phi_ln34_load == 2'd0) ? 1'b1 : 1'b0);

assign icmp_ln14_fu_1038_p2 = ((ap_sig_allocacmp_phi_ln34_load == 2'd2) ? 1'b1 : 1'b0);

assign icmp_ln34_fu_1366_p2 = ((ap_sig_allocacmp_phi_ln34_load == 2'd3) ? 1'b1 : 1'b0);
