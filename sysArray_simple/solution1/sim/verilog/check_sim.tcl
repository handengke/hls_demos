...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.systolic_array.autotvin_gmem.dat"
         "c.systolic_array.autotvin_din_a.dat"
         "c.systolic_array.autotvin_din_b.dat"
         "c.systolic_array.autotvin_out_r.dat"
         "c.systolic_array.autotvout_gmem.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.systolic_array.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
