...
if {[file isfile systolic_array.autotvin.dat]} {
	file delete -force systolic_array.autotvin.dat
}

if {[file isfile systolic_array.autotvout.dat]} {
	file delete -force systolic_array.autotvout.dat
}
