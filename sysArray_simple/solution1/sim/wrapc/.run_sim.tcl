...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "systolic_array.autotvin.dat"
	set constFileTvOut       "systolic_array.autotvout.dat"
	set constFileHdlTvIn     "systolic_array.autohdltvin.dat"
	set constFileHdlTvOut    "systolic_array.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
