...
`define AUTOTB_DUT      systolic_array
`define AUTOTB_DUT_INST AESL_inst_systolic_array
`define AUTOTB_TOP      apatb_systolic_array_top
`define AUTOTB_LAT_RESULT_FILE "systolic_array.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "systolic_array.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_systolic_array_top
...
`define AUTOTB_TVIN_gmem  "./c.systolic_array.autotvin_gmem.dat"
`define AUTOTB_TVIN_din_a  "./c.systolic_array.autotvin_din_a.dat"
`define AUTOTB_TVIN_din_b  "./c.systolic_array.autotvin_din_b.dat"
`define AUTOTB_TVIN_out_r  "./c.systolic_array.autotvin_out_r.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "./rtl.systolic_array.autotvin_gmem.dat"
`define AUTOTB_TVIN_din_a_out_wrapc  "./rtl.systolic_array.autotvin_din_a.dat"
`define AUTOTB_TVIN_din_b_out_wrapc  "./rtl.systolic_array.autotvin_din_b.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "./rtl.systolic_array.autotvin_out_r.dat"
`define AUTOTB_TVOUT_gmem  "./c.systolic_array.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "./impl_rtl.systolic_array.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 97;
