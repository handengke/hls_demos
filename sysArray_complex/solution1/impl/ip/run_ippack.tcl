...
set Library     "hls"
set IPName      "systolic_array"
set Version     "1.0"
set DisplayName "Systolic_array"
set Revision    "2112701917"
...
set xo_kernel_name "systolic_array"
set xo_kernel_files {/home/handengke/HLS/sysArray_complex/sysArray.cpp}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/handengke/HLS/sysArray_complex/solution1"
set debug_dir "/home/handengke/HLS/sysArray_complex/solution1/.debug"
set xo_hls_files_dir "/home/handengke/HLS/sysArray_complex/solution1/impl/ip/hls_files"
set hdl_module_list {systolic_array_flow_control_loop_pipe_sequential_init
...
set kernel_xo "/home/handengke/HLS/sysArray_complex/solution1/impl/export.xo"

## Variables
set Top "systolic_array"
set TopNoPrefix "systolic_array"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 RESERVED_3 R 0 "Reserved.  0s on read." } { 10 22 RESERVED_4 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 din_a_1 W 0x0 "Data signal of din_a" {{0 32 din_a W 0 "Bit 31 to 0 of din_a"}}} {0x14 din_a_2 W 0x0 "Data signal of din_a" {{0 32 din_a W 0 "Bit 63 to 32 of din_a"}}} {0x1c din_b_1 W 0x0 "Data signal of din_b" {{0 32 din_b W 0 "Bit 31 to 0 of din_b"}}} {0x20 din_b_2 W 0x0 "Data signal of din_b" {{0 32 din_b W 0 "Bit 63 to 32 of din_b"}}} {0x28 ra W 0x0 "Data signal of ra" {{0 32 ra W 0 "Bit 31 to 0 of ra"}}} {0x30 ca W 0x0 "Data signal of ca" {{0 32 ca W 0 "Bit 31 to 0 of ca"}}} {0x38 cb W 0x0 "Data signal of cb" {{0 32 cb W 0 "Bit 31 to 0 of cb"}}} {0x40 out_r_1 W 0x0 "Data signal of out_r" {{0 32 out_r W 0 "Bit 31 to 0 of out_r"}}} {0x44 out_r_2 W 0x0 "Data signal of out_r" {{0 32 out_r W 0 "Bit 63 to 32 of out_r"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
