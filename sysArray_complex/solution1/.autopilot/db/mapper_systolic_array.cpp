...
extern "C" void systolic_array(int*, int, int, int, int, int, int);
extern "C" void apatb_systolic_array_hw(volatile void * __xlx_apatb_param_din_a, volatile void * __xlx_apatb_param_din_b, int __xlx_apatb_param_ra, int __xlx_apatb_param_ca, int __xlx_apatb_param_cb, volatile void * __xlx_apatb_param_out) {
  ...
  int __xlx_size_param_din_b = 64;
  int __xlx_offset_param_din_b = 64;
  int __xlx_offset_byte_param_din_b = 64*4;
  for (int j = 0, e = 64; j != e; ++j) {
    sc_bv<32> _xlx_tmp_sc;
  ...
  int __xlx_size_param_out = 64;
  int __xlx_offset_param_out = 128;
  int __xlx_offset_byte_param_out = 128*4;
  ...
  // DUT call
  systolic_array(__xlx_din_a_din_b_out__input_buffer, __xlx_offset_byte_param_din_a, __xlx_offset_byte_param_din_b, __xlx_apatb_param_ra, __xlx_apatb_param_ca, __xlx_apatb_param_cb, __xlx_offset_byte_param_out);
