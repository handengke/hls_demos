...
// wrapc file define:
#define AUTOTB_TVIN_ra "../tv/cdatafile/c.systolic_array.autotvin_ra.dat"
#define AUTOTB_TVOUT_ra "../tv/cdatafile/c.systolic_array.autotvout_ra.dat"
// wrapc file define:
#define AUTOTB_TVIN_ca "../tv/cdatafile/c.systolic_array.autotvin_ca.dat"
#define AUTOTB_TVOUT_ca "../tv/cdatafile/c.systolic_array.autotvout_ca.dat"
// wrapc file define:
#define AUTOTB_TVIN_cb "../tv/cdatafile/c.systolic_array.autotvin_cb.dat"
#define AUTOTB_TVOUT_cb "../tv/cdatafile/c.systolic_array.autotvout_cb.dat"
// wrapc file define:
...
// tvout file define:
#define AUTOTB_TVOUT_PC_ra "../tv/rtldatafile/rtl.systolic_array.autotvout_ra.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_ca "../tv/rtldatafile/rtl.systolic_array.autotvout_ca.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_cb "../tv/rtldatafile/rtl.systolic_array.autotvout_cb.dat"
// tvout file define:
...
string get_depth_list () {
  ...
  total_list << "{ra " << ra_depth << "}\n";
  total_list << "{ca " << ca_depth << "}\n";
  total_list << "{cb " << cb_depth << "}\n";
...
extern "C" void systolic_array_hw_stub_wrapper(volatile void *, volatile void *, int, int, int, volatile void *);

extern "C" void apatb_systolic_array_hw(volatile void * __xlx_apatb_param_din_a, volatile void * __xlx_apatb_param_din_b, int __xlx_apatb_param_ra, int __xlx_apatb_param_ca, int __xlx_apatb_param_cb, volatile void * __xlx_apatb_param_out) {
    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > gmem_pc_buffer(192);
          int i = 0;
          ...
          if (i > 0) {{
            int i = 0;
            for (int j = 0, e = 64; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_din_a)[j*4+0] = gmem_pc_buffer[i].range(7, 0).to_int64();
...
((char*)__xlx_apatb_param_din_a)[j*4+3] = gmem_pc_buffer[i].range(31, 24).to_int64();
            ...
            for (int j = 0, e = 64; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_din_b)[j*4+0] = gmem_pc_buffer[i].range(7, 0).to_int64();
...
((char*)__xlx_apatb_param_din_b)[j*4+3] = gmem_pc_buffer[i].range(31, 24).to_int64();
            ...
            for (int j = 0, e = 64; j < e; j += 1, ++i) {((char*)__xlx_apatb_param_out)[j*4+0] = gmem_pc_buffer[i].range(7, 0).to_int64();
...
//ra
aesl_fh.touch(AUTOTB_TVIN_ra);
aesl_fh.touch(AUTOTB_TVOUT_ra);
//ca
aesl_fh.touch(AUTOTB_TVIN_ca);
aesl_fh.touch(AUTOTB_TVOUT_ca);
//cb
aesl_fh.touch(AUTOTB_TVIN_cb);
aesl_fh.touch(AUTOTB_TVOUT_cb);
//out
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_din_a)[j];
  ...
  __xlx_offset_byte_param_din_b = 64*4;
...
sc_bv<32> __xlx_tmp_lv = ((int*)__xlx_apatb_param_din_b)[j];
  ...
  __xlx_offset_byte_param_out = 128*4;
...
// print ra Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_ra, __xlx_sprintf_buffer.data());
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_ra);

    std::string s(__xlx_tmp_lv.to_string(SC_HEX));
    aesl_fh.write(AUTOTB_TVIN_ra, s.append("\n")); 
  }
  tcl_file.set_num(1, &tcl_file.ra_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_ra, __xlx_sprintf_buffer.data());
}
// print ca Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_ca, __xlx_sprintf_buffer.data());
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_ca);

    std::string s(__xlx_tmp_lv.to_string(SC_HEX));
    aesl_fh.write(AUTOTB_TVIN_ca, s.append("\n")); 
  }
  tcl_file.set_num(1, &tcl_file.ca_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_ca, __xlx_sprintf_buffer.data());
}
// print cb Transactions
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVIN_cb, __xlx_sprintf_buffer.data());
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)&__xlx_apatb_param_cb);

    std::string s(__xlx_tmp_lv.to_string(SC_HEX));
    aesl_fh.write(AUTOTB_TVIN_cb, s.append("\n")); 
  }
  tcl_file.set_num(1, &tcl_file.cb_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_cb, __xlx_sprintf_buffer.data());
}
...
systolic_array_hw_stub_wrapper(__xlx_apatb_param_din_a, __xlx_apatb_param_din_b, __xlx_apatb_param_ra, __xlx_apatb_param_ca, __xlx_apatb_param_cb, __xlx_apatb_param_out);
