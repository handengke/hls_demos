...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "simd_array.autotvin.dat"
	set constFileTvOut       "simd_array.autotvout.dat"
	set constFileHdlTvIn     "simd_array.autohdltvin.dat"
	set constFileHdlTvOut    "simd_array.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
