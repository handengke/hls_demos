...
if {[file isfile simd_array.autotvin.dat]} {
	file delete -force simd_array.autotvin.dat
}

if {[file isfile simd_array.autotvout.dat]} {
	file delete -force simd_array.autotvout.dat
}
