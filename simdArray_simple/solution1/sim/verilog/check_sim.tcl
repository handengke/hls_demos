...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.simd_array.autotvin_gmem0.dat"
         "c.simd_array.autotvin_gmem1.dat"
         "c.simd_array.autotvin_din_a.dat"
         "c.simd_array.autotvin_din_b.dat"
         "c.simd_array.autotvin_out_r.dat"
         "c.simd_array.autotvin_size.dat"
         "c.simd_array.autotvin_opcode.dat"
         "c.simd_array.autotvout_gmem0.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.simd_array.autotvout_gmem0.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
