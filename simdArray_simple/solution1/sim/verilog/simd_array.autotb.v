...
`define AUTOTB_DUT      simd_array
`define AUTOTB_DUT_INST AESL_inst_simd_array
`define AUTOTB_TOP      apatb_simd_array_top
`define AUTOTB_LAT_RESULT_FILE "simd_array.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "simd_array.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_simd_array_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 1.50

`define AESL_DEPTH_gmem0 1
`define AESL_DEPTH_gmem1 1
`define AESL_DEPTH_din_a 1
`define AESL_DEPTH_din_b 1
...
`define AUTOTB_TVIN_out_r  "../tv/cdatafile/c.simd_array.autotvin_out_r.dat"
...
`define AUTOTB_TVIN_gmem0_out_wrapc  "../tv/rtldatafile/rtl.simd_array.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1_out_wrapc  "../tv/rtldatafile/rtl.simd_array.autotvin_gmem1.dat"
`define AUTOTB_TVIN_din_a_out_wrapc  "../tv/rtldatafile/rtl.simd_array.autotvin_din_a.dat"
`define AUTOTB_TVIN_din_b_out_wrapc  "../tv/rtldatafile/rtl.simd_array.autotvin_din_b.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "../tv/rtldatafile/rtl.simd_array.autotvin_out_r.dat"
`define AUTOTB_TVIN_size_out_wrapc  "../tv/rtldatafile/rtl.simd_array.autotvin_size.dat"
`define AUTOTB_TVIN_opcode_out_wrapc  "../tv/rtldatafile/rtl.simd_array.autotvin_opcode.dat"
`define AUTOTB_TVOUT_gmem0  "../tv/cdatafile/c.simd_array.autotvout_gmem0.dat"
`define AUTOTB_TVOUT_gmem0_out_wrapc  "../tv/rtldatafile/rtl.simd_array.autotvout_gmem0.dat"
module `AUTOTB_TOP;
...
parameter LENGTH_din_a = 1;
parameter LENGTH_din_b = 1;
...
reg end_din_a;
reg [31:0] size_din_a;
reg [31:0] size_din_a_backup;
reg end_din_b;
reg [31:0] size_din_b;
reg [31:0] size_din_b_backup;
reg end_out_r;
reg [31:0] size_out_r;
...
reg end_opcode;
reg [31:0] size_opcode;
reg [31:0] size_opcode_backup;
