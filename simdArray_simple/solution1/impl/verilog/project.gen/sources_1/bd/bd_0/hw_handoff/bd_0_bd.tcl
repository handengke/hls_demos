...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ap_clk [ create_bd_port -dir I -type clk -freq_hz 333000000.0 ap_clk ]
  set ap_rst_n [ create_bd_port -dir I -type rst ap_rst_n ]
  set interrupt [ create_bd_port -dir O -type intr interrupt ]

  # Create instance: hls_inst, and set properties
  set hls_inst [ create_bd_cell -type ip -vlnv xilinx.com:hls:simd_array:1.0 hls_inst ]

  # Create interface connections
  connect_bd_intf_net -intf_net hls_inst_m_axi_gmem0 [get_bd_intf_ports m_axi_gmem0] [get_bd_intf_pins hls_inst/m_axi_gmem0]
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces hls_inst/Data_m_axi_gmem0] [get_bd_addr_segs m_axi_gmem0/Reg] -force
