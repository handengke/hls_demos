...
module simd_array_simd_array_Pipeline_VITIS_LOOP_96_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln96_fu_344_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln96_fu_344_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_reg_454 <= tmp_fu_360_p34;
    end
end

always @ (*) begin
    if (((icmp_ln96_fu_344_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln96_fu_350_p2 = (ap_sig_allocacmp_i_1 + 6'd1);
...
assign icmp_ln96_fu_344_p2 = ((ap_sig_allocacmp_i_1 == 6'd32) ? 1'b1 : 1'b0);
...
assign m_axi_gmem_WDATA = tmp_reg_454;
...
assign tmp_fu_360_p33 = ap_sig_allocacmp_i_1[4:0];

endmodule //simd_array_simd_array_Pipeline_VITIS_LOOP_96_3
