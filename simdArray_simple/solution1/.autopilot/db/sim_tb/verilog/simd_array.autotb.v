...
`define AUTOTB_TVIN_gmem0  "./c.simd_array.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1  "./c.simd_array.autotvin_gmem1.dat"
`define AUTOTB_TVIN_din_a  "./c.simd_array.autotvin_din_a.dat"
`define AUTOTB_TVIN_din_b  "./c.simd_array.autotvin_din_b.dat"
`define AUTOTB_TVIN_out_r  "./c.simd_array.autotvin_out_r.dat"
`define AUTOTB_TVIN_size  "./c.simd_array.autotvin_size.dat"
`define AUTOTB_TVIN_opcode  "./c.simd_array.autotvin_opcode.dat"
`define AUTOTB_TVIN_gmem0_out_wrapc  "./rtl.simd_array.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem1_out_wrapc  "./rtl.simd_array.autotvin_gmem1.dat"
`define AUTOTB_TVIN_din_a_out_wrapc  "./rtl.simd_array.autotvin_din_a.dat"
`define AUTOTB_TVIN_din_b_out_wrapc  "./rtl.simd_array.autotvin_din_b.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "./rtl.simd_array.autotvin_out_r.dat"
`define AUTOTB_TVIN_size_out_wrapc  "./rtl.simd_array.autotvin_size.dat"
`define AUTOTB_TVIN_opcode_out_wrapc  "./rtl.simd_array.autotvin_opcode.dat"
`define AUTOTB_TVOUT_gmem0  "./c.simd_array.autotvout_gmem0.dat"
`define AUTOTB_TVOUT_gmem0_out_wrapc  "./impl_rtl.simd_array.autotvout_gmem0.dat"
module `AUTOTB_TOP;
