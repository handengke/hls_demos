...
extern "C" void simd_array(int*, int*, int, int, int, int, int);
extern "C" void apatb_simd_array_hw(volatile void * __xlx_apatb_param_din_a, volatile void * __xlx_apatb_param_din_b, volatile void * __xlx_apatb_param_out, int __xlx_apatb_param_size, int __xlx_apatb_param_opcode) {
  // Collect __xlx_din_a_out__tmp_vec
  vector<sc_bv<32> >__xlx_din_a_out__tmp_vec;
  for (int j = 0, e = 32; j != e; ++j) {
    ...
    __xlx_din_a_out__tmp_vec.push_back(_xlx_tmp_sc);
  }
  ...
  int __xlx_offset_param_out = 32;
  int __xlx_offset_byte_param_out = 32*4;
  int* __xlx_din_a_out__input_buffer= new int[__xlx_din_a_out__tmp_vec.size()];
  for (int i = 0; i < __xlx_din_a_out__tmp_vec.size(); ++i) {
    __xlx_din_a_out__input_buffer[i] = __xlx_din_a_out__tmp_vec[i].range(31, 0).to_uint64();
  }
  // Collect __xlx_din_b__tmp_vec
  vector<sc_bv<32> >__xlx_din_b__tmp_vec;
  for (int j = 0, e = 32; j != e; ++j) {
    sc_bv<32> _xlx_tmp_sc;
    ...
    __xlx_din_b__tmp_vec.push_back(_xlx_tmp_sc);
  }
  int __xlx_size_param_din_b = 32;
  int __xlx_offset_param_din_b = 0;
  int __xlx_offset_byte_param_din_b = 0*4;
  int* __xlx_din_b__input_buffer= new int[__xlx_din_b__tmp_vec.size()];
  for (int i = 0; i < __xlx_din_b__tmp_vec.size(); ++i) {
    __xlx_din_b__input_buffer[i] = __xlx_din_b__tmp_vec[i].range(31, 0).to_uint64();
  }
  // DUT call
  simd_array(__xlx_din_a_out__input_buffer, __xlx_din_b__input_buffer, __xlx_offset_byte_param_din_a, __xlx_offset_byte_param_din_b, __xlx_offset_byte_param_out, __xlx_apatb_param_size, __xlx_apatb_param_opcode);
// print __xlx_apatb_param_din_a
  ...
  for (int i = 0; i < __xlx_size_param_din_a; ++i) {
    __xlx_din_a_output_buffer[i] = __xlx_din_a_out__input_buffer[i+__xlx_offset_param_din_a];
  }
  for (int i = 0; i < __xlx_size_param_din_a; ++i) {
...
// print __xlx_apatb_param_out
  ...
  for (int i = 0; i < __xlx_size_param_out; ++i) {
    __xlx_out_output_buffer[i] = __xlx_din_a_out__input_buffer[i+__xlx_offset_param_out];
  }
  for (int i = 0; i < __xlx_size_param_out; ++i) {
...
// print __xlx_apatb_param_din_b
  ...
  for (int i = 0; i < __xlx_size_param_din_b; ++i) {
    __xlx_din_b_output_buffer[i] = __xlx_din_b__input_buffer[i+__xlx_offset_param_din_b];
  }
  for (int i = 0; i < __xlx_size_param_din_b; ++i) {
